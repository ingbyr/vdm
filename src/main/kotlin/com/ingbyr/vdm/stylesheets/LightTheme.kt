...
class LightTheme : Stylesheet() {
    // main color
    private val primaryColor = app.config.color(Attributes.THEME_PRIMARY_COLOR, Attributes.Defaults.THEME_PRIMARY_COLOR)
    private val secondaryColor = app.config.color(Attributes.THEME_SECONDARY_COLOR, Attributes.Defaults.THEME_SECONDARY_COLOR)
