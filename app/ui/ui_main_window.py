...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.button_download.setGeometry(QtCore.QRect(300, 20, 41, 41))
...
"")
        ...
        self.text_edit_urls.setGeometry(QtCore.QRect(50, 20, 241, 41))
        self.text_edit_urls.setObjectName("text_edit_urls")
        self.task_widget = QtWidgets.QListWidget(self.central_widget)
        self.task_widget.setGeometry(QtCore.QRect(10, 90, 331, 351))
        self.task_widget.setObjectName("task_widget")
        MainWindow.setCentralWidget(self.central_widget)
        self.menu_bar = QtWidgets.QMenuBar(MainWindow)
        self.menu_bar.setGeometry(QtCore.QRect(0, 0, 350, 22))
